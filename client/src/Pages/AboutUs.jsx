  ...
  const features = [
    {
      ...
      title: "Holistic Development",
      description:
        "Our curriculum nurtures cognitive, social, emotional, and physical growth",
    },
    {
      icon: <FiUsers className='w-8 h-8' />,
      title: "Passionate Educators",
      description:
        "Certified teachers dedicated to early childhood development",
    },
    {
      icon: <FiAward className='w-8 h-8' />,
      title: "Proven Methodology",
    ...
    <div className='bg-'>
      ...
      <section className='relative py-10 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-5xl mx-auto'>
          {" "}
          {/* Changed from 7xl to 5xl */}
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            <div className='relative z-10'>
              <h1 className='text-2xl md:text-4xl font-bold  text-center mb-6 text-[#00008b]'>
                Welcome to{" "}
                <span style={{ color: theme.primaryColor }}>BunnyTots</span>{" "}
              ...
              <div className='flex flex-wrap gap-4'>
                <button
                  className='px-6 py-2 rounded-full font-bold text-white transition-all hover:shadow-lg'
                  style={{ backgroundColor: theme.primaryColor }}
                >
                  Enquire Now
                </button>
            ...
            <div className='relative'>
              ...
              <div
                ...
                style={{ backgroundColor: theme.secondaryColor, opacity: 0.2 }}
              ></div>
              <div
        ...
        <div className='max-w-3xl mx-auto text-center'>
          ...
          <div className='relative'>
            <blockquote
              ...
              style={{ color: theme.accentTextColor }}
            >
              "We believe early childhood education is not just about academics
              but about fostering creativity, curiosity, and confidence."
            </blockquote>
            <div
            ...
            <div
              className='absolute -bottom-6 -right-6 text-6xl opacity-10'
              style={{ color: theme.primaryColor }}
            >
              "
            </div>
          ...
          <p className='text-md mb-8' style={{ color: theme.accentTextColor }}>
            Our BunnyLearn curriculum blends play-based learning with structured
            activities, ensuring holistic development in a safe and stimulating
            environment.
          </p>
          <div
            ...
            {features.map((feature, index) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: ` ${theme.primaryColor}20, color: theme.primaryColor`,
                  }}
                >
                  {feature.icon}
                </div>
                ...
                <p className='text-sm' style={{ color: theme.accentTextColor }}>
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <div className='max-w-5xl mx-auto'>
          ...
          <div className='grid md:grid-cols-2 gap-8 items-center'>
            ...
            <div className='order-2 md:order-1'>
              ...
              >
                <p>
                  Founded 7 years ago, BunnyTots International Preschool began
                  with a simple mission: to create a nurturing space where
                  children could develop a lifelong love for learning.
                </p>
                <p>
                  What started as a small preschool has grown into a respected
                  institution known for its child-centric approach and
                  innovative curriculum.
                </p>
                <p>
                  Today, we take pride in our modern infrastructure, passionate
                  educators, and the warm, welcoming atmosphere that makes
                  learning joyful for every child.
                </p>
              </div>
              <div className='mt-6 flex items-center space-x-3'>
                <div
      ...
      >
        <div className='max-w-3xl mx-auto text-center text-white'>
          ...
          <button
            className='px-8 py-3 rounded-full font-bold transition-all hover:shadow-lg bg-white'
            style={{ color: theme.primaryColor }}
          >
            Schedule a Visit
          </button>

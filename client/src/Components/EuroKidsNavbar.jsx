...
const EuroKidsNavbar = () => {
  ...
  const socialLinks = [
    { icon: <FaFacebook />, path: "https://www.facebook.com/bunny.tots.94?mibextid=b06tZ0" },
    // { icon: <FaTwitter />, path: "https://twitter.com" },
    { icon: <FaInstagram />, path: "https://instagram.com/bunnytots_official?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D" },
    { icon: <FaYoutube />, path: "https://youtube.com/@bunnytots-pe9be?si=9nyGoyKoLUQsj8ce" },
  ];
